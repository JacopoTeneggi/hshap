...
for i, batch in enumerate(dataloader):
    ...
    running_mean = running_count / (running_count + batch_images) * running_mean + batch_images / (running_count + batch_images) * batch_mean
    running_var = running_count / (running_count + batch_images) * running_var + batch_images / (running_count + batch_images) * batch_var + running_count*batch_images/(running_count + batch_images)**2 * (running_mean - batch_mean)**2
