...
if HOME == "gaon":
    weight_path = (
        "/export/gaon1/data/jteneggi/data/rsna/pretrained-models/RSNA_InceptionV3.pth"
    )
else:
    weight_path = os.path.join(
        HOME, "repo/hshap/data/rsna/pretrained-models/RSNA_InceptionV3.pth"
    )
...
if HOME == "gaon":
    np.save(
        os.path.join(
            "/cis/home/jteneggi",
            "repo/hshap/hshap/experiments/rsna/LOR/results/_{}_{}_{}_{}.npy".format(
                explainer_name, EXP_SIZE, REF_SIZE, MIN_SIZE
            ),
        ),
        LOR.cpu().numpy(),
    )
